...
QWidget#LastSeenFiveSlots {
    background: #181a1d;
    border: 1px solid #41464c;
}
QWidget#LastSeenSlotsHeader {
    background: #292c30;
    border-bottom: 1px solid #44494f;
}
QLabel#LastSeenSlotsHeaderLabel {
    color: #c7cbd0;
    font-size: 8pt;
    font-weight: 600;
}
QFrame#LastSeenSlotRow {
    background: #181a1d;
    border-bottom: 1px solid #25282c;
}
QLabel#LastSeenSlotCell {
    color: #e8eaec;
    font-size: 8.5pt;
    font-weight: 500;
    background: transparent;
}
QLabel#LastSeenSlotSprite {
    background: #121416;
    border-radius: 3px;
}
"""
